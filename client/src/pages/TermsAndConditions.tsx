...
const sections = [
  {
    ...
    content: [
      "By accessing or using the AEVIQ Labs website at aeviqlabs.site, or by engaging our services, you agree to be bound by these Terms and Conditions. If you do not agree to these terms, please do not use our website or services.",
  ...
  },
  {
    ...
    content: [
      "AEVIQ Labs provides custom digital engineering services including but not limited to web application development, CRM and ERP software development, AI-powered automation, medical diagnostic portals, real estate platforms, event management systems, and related technology consulting.",
      "All services are subject to a separate written agreement or Statement of Work (SOW) signed between AEVIQ Labs and the client. In the absence of a signed agreement, these Terms govern the engagement.",
    ],
  },
  {
    title: "3. Intellectual Property",
    content: [
      "Upon full payment for the project, the client receives ownership of the final deliverables as specified in the project agreement. AEVIQ Labs retains the right to showcase completed work in its portfolio unless explicitly restricted in the project agreement.",
      "Any proprietary frameworks, tools, libraries, templates, or internal methodologies developed or used by AEVIQ Labs remain the exclusive property of AEVIQ Labs.",
  ...
  },
  {
    ...
    content: [
      ...
      "Late payments may attract a delay penalty as outlined in the project agreement. AEVIQ Labs reserves the right to suspend work on overdue accounts.",
  ...
  },
  {
    ...
    content: [
      "Both parties agree to keep confidential all non-public information shared during the engagement. AEVIQ Labs will not disclose your business data, processes, or proprietary information to third parties without your written consent.",
  ...
  },
  {
    ...
    content: [
      "AEVIQ Labs' total liability for any claim arising from our services shall not exceed the total amount paid by the client for the specific service giving rise to the claim.",
      ...
      "AEVIQ Labs does not guarantee specific business outcomes (such as revenue growth or search engine rankings) as a result of our services.",
    ],
  },
  {
    title: "8. Warranties",
    content: [
      "AEVIQ Labs warrants that all deliverables will be original work or properly licensed, and will function substantially as described in the project specification at the time of delivery.",
  ...
  },
  {
    ...
    content: [
      ...
      "AEVIQ Labs reserves the right to terminate an engagement immediately for non-payment or breach of these Terms.",
    ],
  },
  {
  ...
  },
  {
    ...
    content: [
      ...
      "AEVIQ Labs reserves the right to restrict or terminate access to the website for any user who violates these Terms.",
    ],
  },
  {
    title: "12. Contact",
      ...
      >
        ...
        <div className="relative max-w-4xl mx-auto px-6">
          ...
          <p className="text-base text-[#5a5a7a] max-w-2xl leading-relaxed">
            These Terms and Conditions govern your use of the AEVIQ Labs website and our digital engineering services.
